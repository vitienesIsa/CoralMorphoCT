...
This tool was developed as part of a larger study, "Asymmetric Depth Acclimation and Plasticity Limit the Refugial Potential of Mesophotic Porites astreoides", investigating adaptation to depth changes in corals, specifically Porites astreoides. The full project repository — including data, additional scripts, data processing workflows, and supporting material — will be linked once published. 
